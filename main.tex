...
The source code of the Dopplerguesser system developed during this study is publicly available at https://github.com/BUSH222/dopplerguesser \citep{dopplerguesser}. The software is released under the MIT License. The raw IQ recordings and frequency time-series files supporting the conclusions of this article are available from the corresponding author on reasonable request.
...
F.I.V. conceived the method, implemented the software, conducted all observations, performed the analysis, and wrote the manuscript.
